// Role-Based Access Control Configuration
      ...
      let users = [
        {
          id: 1,
          name: "John Doe",
          email: "john.doe@lunarcancercare.com",
          role: "admin",
        ...
        },
        {
          id: 2,
          name: "Dr. Achieng",
          email: "dr.achieng@lunarcancercare.com",
          role: "doctor",
          department: "oncology",
          active: true,
          avatar: "DA",
        },
        {
          id: 3,
          name: "Nurse Jane",
          email: "nurse.jane@lunarcancercare.com",
          role: "nurse",
          department: "oncology",
          active: true,
          avatar: "NJ",
        },
        {
          ...
          email: "pharmacist.john@lunarcancercare.com",
          role: "pharmacist",
          department: "pharmacy",
          active: true,
          avatar: "PJ",
      ...
      // Backup information
      let backupInfo = {
        lastBackup: "2025-11-20T02:00:00",
        backupSize: "245 MB",
      ...
      const cancelUserChangesBtn = document.getElementById(
        "cancel-user-changes"
      );
      ...
      const restoreBackupModal = document.getElementById(
      ...
      const cancelNotificationsBtn = document.getElementById(
      ...
      function setupEventListeners() {
        ...
        cancelNotificationsBtn.addEventListener(
          "click",
        ...
        cancelRestoreBtn.addEventListener(
          "click",
      ...
      function loadSystemSettings() {
        ...
        document.getElementById("time-format").value =
          systemSettings.timeFormat;
        document.getElementById("report-period").value =
          systemSettings.reportPeriod;
      }
      ...
      function downloadBackup() {
        ...
        setTimeout(() => {
          ...
          downloadAnchorNode.setAttribute(
            "download",
            `lunar_backup_${new Date().toISOString().slice(0, 10)}.txt`
          );
      ...
      function restoreBackup() {
        ...
        if (!confirmCheckbox.checked) {
          showAlert(
            "Please confirm that you understand this will replace all current data.",
            "error"
          );
          return;
        }
      ...
      function applyRolePermissions() {
        ...
        addUserBtn.style.display = permissions.settings.users.create
          ? "flex"
          : "none";
        document.querySelectorAll(".btn-edit").forEach((btn) => {
        ...
        document.querySelectorAll(".btn-delete").forEach((btn) => {
          btn.style.display = permissions.settings.users.delete
            ? "flex"
            : "none";
        });
        saveUserChangesBtn.style.display = permissions.settings.modify
          ? "flex"
          : "none";
        savePreferencesBtn.style.display = permissions.settings.system.modify
          ? "flex"
          : "none";
        downloadBackupBtn.style.display = permissions.settings.backup.create
          ? "flex"
          : "none";
        createBackupBtn.style.display = permissions.settings.backup.create
          ? "flex"
          : "none";
        restoreBackupBtn.style.display = permissions.settings.backup.restore
          ? "flex"
          : "none";
